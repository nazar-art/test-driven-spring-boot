...
public class ConverterService {
    public void toAnimatedGif(FFmpegFrameGrabber frameGrabber, AnimatedGifEncoder gifEncoder,
                              int start, int end, int speed) throws FrameGrabber.Exception {
        ...
        for (long i = startFrame; i < endFrame; i++) {
            ...
            if (i % speed == 0) {
                ...
                BufferedImage bufferedImage = frameConverter.convert(frameGrabber.grabImage());
